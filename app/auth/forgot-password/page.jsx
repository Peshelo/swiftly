        ...
        <>
            <div className="flex flex-col h-full w-full justify-center items-center p-10">
                <form onSubmit={(e)=>{
                    ...
                    <Input type="email" placeholder="Email" name="username" value={username} onChange={(e)=>setUsername(e.target.value)} onFocus={()=>setErrorMsg('')} />

                    {/* <Input type="password" placeholder="Password" name="password" value={formData.password} onChange={handleInputChange}/> */}
                    <Button variant={''} type="submit" className="w-full p-2">Sent reset to email</Button>
